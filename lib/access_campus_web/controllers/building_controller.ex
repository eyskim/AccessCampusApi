defmodule AccessCampusWeb.BuildingController do
  use AccessCampusWeb, :controller

  alias AccessCampus.Locations
  alias AccessCampus.Locations.Building

  action_fallback AccessCampusWeb.FallbackController
